...
"""
Adopted from https://github.com/raspstephan/nwp-downscale/blob/main/src/callbacks.py
"""

class StopIfNan(Callback):
    def __init__(self, monitor: list = ['loss'],
    ...
    def on_train_batch_end(self, trainer: "pl.Trainer", pl_module: "pl.LightningModule", outputs: STEP_OUTPUT,
        ...
        skip_batch = ((step + 1) % self._every_n_train_steps != 0) and (
                    max(step - 2, 1) % self._model_save_every_n_train_steps != 0)
