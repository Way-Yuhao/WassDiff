...
class TiggeMRMSDataset(Dataset):
    ...
    def __init__(self, tigge_dir, tigge_vars, mrms_dir, lead_time=12, patch_size=512, rq_fn=None,
        ...
        self.tigge.load();
        self.mrms.load()  # Load datasets into RAM
        if tp_log:
        ...
        self.var_names = {'total_precipitation': 'tp', 'total_precipitation_ens10': 'tp', 'total_column_water': 'tcw',
                          'total_column_water_ens10': 'tcw', '2m_temperature': 't2m',
                          'convective_available_potential_energy': 'cape', 'convective_inhibition': 'cin'}
