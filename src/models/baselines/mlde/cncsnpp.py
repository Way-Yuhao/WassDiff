...
# from mlde_utils.training.dataset import get_variables # Yuhao: unavailable
...
class cNCSNpp(nn.Module):
  ...
  def __init__(self, config):
    ...
    cond_var_channels, output_channels = config.data.num_context_chs + 1, config.data.num_channels # + 1 to include prec itsefl
